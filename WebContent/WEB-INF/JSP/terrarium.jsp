...
<body>
	...
	<form method="post">
		...
		<label> <input type="number" name="breedteNieuw" placeholder="Breedte" required autocomplete='off' value='${terrarium.breedte}'/><span class='fout'>${fouten.breedte}</span> </label><br> 
		<label><input type="number" name="hoogteNieuw" placeholder="Hoogte" required autocomplete='off' value='${terrarium.hoogte}'/><span class='fout'>${fouten.hoogte}</span></label><br> 
